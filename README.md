...
```bash
# Install from GitHub
pip install git+https://github.com/Texera/texera-rudf.git

# Development install
git clone https://github.com/Texera/texera-rudf.git
cd texera-rudf
pip install -e .
```
...
- **Issues**: https://github.com/Texera/texera-rudf/issues
